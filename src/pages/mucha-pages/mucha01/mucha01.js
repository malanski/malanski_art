...
import bigmucha0 from '../../../assets/bigmucha0.png';
  ...
  return (
    <section className="project-page">
      ...
      <div className="project-navigation">
        <Link to="/mucha00"><Button><FontAwesomeIcon icon={faArrowAltCircleLeft}></FontAwesomeIcon>preview</Button></Link>
        <Link to="/mucha02"><Button>next<FontAwesomeIcon icon={faArrowAltCircleRight}></FontAwesomeIcon></Button></Link>
      </div>
